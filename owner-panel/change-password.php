            ...
            <div class="card-body p-5">
              ...
              <form>
                ...
                <div class="form-outline mb-4">
                  <input type="text" id="form3Example3cg" name="current" class="form-control form-control-lg" />
                  <label class="form-label" for="form3Example3cg">Current Password</label>
                </div>

                <div class="form-outline mb-4">
                  <input type="password" id="form3Example4cg" name="new" class="form-control form-control-lg" />
                  <label class="form-label" for="form3Example4cg">Password</label>
                </div>

                <div class="form-outline mb-4">
                  <input type="password" id="form3Example4cdg" name="repeat" class="form-control form-control-lg" />
