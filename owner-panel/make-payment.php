            ...
            <form class="px-md-2">
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-4">
                  ...
                  <select class="select" style="width: auto; padding: 10px;">
              ...
              <div class="col-md-6 mb-4">
                  ...
                  <div class="form-outline datepicker">
                    ...
                    <input type="text" class="form-control" id="exampleDatepicker1" value="ARVIND VERMA" disabled/>
              ...
              <button type="submit" class="btn btn-success btn-lg mb-1">Click To Pay</button>
